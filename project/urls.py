...
from ejemplo.views import index, monstrar_familiares, BuscarFamiliar, AltaFamiliar, AltaPersona, AltaVuelo
...
urlpatterns = [
    ...
    path('persona/alta', AltaPersona.as_view()),
    path('vuelo/alta', AltaVuelo.as_view()),
]
